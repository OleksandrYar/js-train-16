...
function filterStudentsByGrade(students, grade) {
  ...
  const filterGrades = students.filter((student) => student.grade === grade);
...
function countVowelsAndConsonants(word) {
  ...
  for (const letter of word) {
    ...
    // Перевіряємо, чи є літера в нашому рядку з голосними, якщо так, то збільшуємо лічильник голосних, інакше приголосних
